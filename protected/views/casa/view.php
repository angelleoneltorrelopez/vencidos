...
$this->widget("bootstrap.widgets.TbButtonGroup", array(
						...
						"buttons"=>array(
								...
								'url'=>'#', "htmlOptions" => array("class"=>"btn btn-info",'submit'=>array('delete','id'=>$model->idcasa),'confirm'=>
								'Seguro querer borrar este producto? '.$model->nombrecasa)),

								array('label'=>'<img src="'.Yii::app()->baseUrl.'/images/exchange.png"/><strong> Actualizar</strong>',
								'url'=>array('update','id'=>$model->idcasa), "htmlOptions" => array("class"=>"btn btn-info")),
