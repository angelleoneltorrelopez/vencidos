...
<!--mpdf
 ...
 <td width="50%" style="color:#0000BB;"><span style="font-weight: bold; font-size: 14pt;">Farmacia Acevedo</span>
  ...
  <td width="50%" style="text-align: right;"><b>Listado de Casas</b></td>
 </tr></table>
 </htmlpageheader>
...
<b>Total Resultados:</b> <?php echo $contador; ?>
 ...
 <thead>
 <tr>
 <td width="8.666666666667%"><b>ID</b></td>
 <td width="88.666666666667%"><b>CASA</b></td>
 </tr>
 </thead>
 <tbody>
 <!-- ITEMS -->
