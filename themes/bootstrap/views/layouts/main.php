...
'visible'=>strtolower(Yii::app()->user->name) == 'angel' || strtolower(Yii::app()->user->name) == 'keyla'),
 array('label'=>'Admin', 'icon'=>'star', 'url'=>array('/admin/admin'),'visible'=>strtolower(Yii::app()->user->name) == 'angel' || Yii::app()->user->name =='admin'),
...
'visible'=>strtolower(Yii::app()->user->name) == 'angel' || strtolower(Yii::app()->user->name) == 'keyla'),
 ...
 'visible'=>strtolower(Yii::app()->user->name) == 'angel' || Yii::app()->user->name =='admin'),
